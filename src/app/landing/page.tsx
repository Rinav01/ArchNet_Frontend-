      ...
      <nav className="landing-nav">
        <div className="landing-nav-inner">
          ...
          <div className="landing-nav-actions">
            ...
            <Link href="/" className="landing-btn-primary">Launch App →</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="landing-hero" ref={heroRef}>
        ...
        <div className={`hero-content ${visible ? 'hero-visible' : ''}`}>
          ...
          <div className="hero-actions">
            <Link href="/" id="hero-launch-btn" className="landing-btn-primary landing-btn-lg">
              Open Workspace →
            </Link>
      ...
      <section className="landing-cta">
        ...
        <div className="cta-content">
          ...
          <div className="hero-actions" style={{ marginTop: 40 }}>
            <Link href="/" id="cta-launch-btn" className="landing-btn-primary landing-btn-xl">
              Open MLBuilder →
            </Link>
